...
@registration_bp.route('/api/activities/int:activity_id/register', methods=['POST'])
@login_required
...
try:
    ...
    @registration_bp.route('/api/activities/int:activity_id/cancel', methods=['POST'])
@login_required
...
try:
    ...
    @registration_bp.route('/api/my-registrations', methods=['GET'])
@login_required
...
@registration_bp.route('/api/activities/int:activity_id/registration-status', methods=['GET'])
@login_required
