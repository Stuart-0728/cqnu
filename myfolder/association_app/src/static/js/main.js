            ...
            <div class="card">
                <div class="card-body">
                    <form @submit.prevent="createActivity">
                        ...
                        <div class="mb-3">
                            <label for="description" class="form-label">活动描述 <span class="text-danger">*</span></label>
                            <textarea class="form-control" id="description" rows="5" v-model="formData.description" required></textarea>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="max_participants" v-model="formData.max_participants" min="0">
                                <small class="form-text text-muted">留空表示不限制人数</small>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="start_time" class="form-label">开始时间 <span class="text-danger">*</span></label>
                                <input type="datetime-local" class="form-control" id="start_time" v-model="formData.start_time" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="end_time" class="form-label">结束时间 <span class="text-danger">*</span></label>
                                <input type="datetime-local" class="form-control" id="end_time" v-model="formData.end_time" required>
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="registration_deadline" class="form-label">报名截止时间 <span class="text-danger">*</span></label>
                            <input type="datetime-local" class="form-control" id="registration_deadline" v-model="formData.registration_deadline" required>
                        </div>
                        <div class="mb-3">
                            <label for="image" class="form-label">活动海报</label>
                            <input type="file" class="form-control" id="image" @change="handleImageUpload" accept="image/*">
                        </div>
                        <div class="mb-3" v-if="imagePreview">
                            <label class="form-label">海报预览</label>
                            <div class="text-center">
                                <img :src="imagePreview" alt="活动海报预览" class="img-fluid" style="max-height: 300px;">
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <button type="button" class="btn btn-secondary me-md-2" @click="$router.push('/activities')">取消</button>
                            <button type="submit" class="btn btn-primary" :disabled="isLoading">
                                <span v-if="isLoading" class="spinner-border spinner-border-sm" role="status"></span>
                                {{ isLoading ? '创建中...' : '创建活动' }}
                            </button>
    ...
    methods: {
        ...
        async createActivity() {
            ...
            try {
                ...
                if (response.data.success) {
                    this.$root.showToast('成功', '活动创建成功', 'success');
...
const routes = [
    ...
    { path: '/admin/activities/new', component: CreateActivity }
];
